    ...
    var Steptwo = {
        ...
        init: function () {
            ...
            if($("#grade").val()) {
                ...
                if ($("#afrikaans").val()) {
                    Steptwo.feilds.afrikaans = $("#afrikaans").val();    
                }
                if ($("#maths").val()) {
                    Steptwo.feilds.afrikaans = $("#maths").val();    
                }
                if ($("#subject").val()) {
                    Steptwo.feilds.afrikaans = $("#subject").val();    
                }
                Steptwo.changeView();
            }
            ...
            if (view === 'grade') {
                $("#grade").change(function() {
                    ...
                    if ((Steptwo.feilds.grade - Steptwo.feilds.gradepassed) === 1) {
                        ...
                        if ((Steptwo.feilds.grade - Steptwo.feilds.gradepassed) === 0) {
